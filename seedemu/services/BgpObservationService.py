"""Router-first BGP observation service."""
...
from seedemu.core import Emulator, Server, Service

from .BgpServiceCommon import (
...
class BGPObservationService(Service):
    ...
    def _createServer(self) -> Server:
        raise AssertionError("BGPObservationService uses observeRouter() instead of install().")
